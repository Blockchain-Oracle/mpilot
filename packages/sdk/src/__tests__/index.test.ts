// Barrel surface of the @mpilot/sdk META package (story-22 amended).
// Re-exports cover @mpilot/tools + @mpilot/vercel-ai + the SDK's own
// defaultModel / ConciergeRegistry / ConciergeError. The @mpilot/agent
...
describe('@mpilot/sdk barrel', () => {
  ...
  it('re-exports the @mpilot/tools registry surface', () => {
  ...
  it('re-exports the @mpilot/vercel-ai adapter surface', () => {
