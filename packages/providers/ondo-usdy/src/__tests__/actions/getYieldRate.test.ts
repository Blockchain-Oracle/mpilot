...
// Fork note: The Mantle Agni USDY/USDC pool (0xFF74...) was deployed ~2026-06-05.
// The pool has <7 days of TWAP history as of 2026-06-11, so the fork test verifies
// the InsufficientLiquidity error path. Unit tests verify the ~500 bps happy path.
