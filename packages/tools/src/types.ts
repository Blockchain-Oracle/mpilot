...
//  - `chainId` narrowed to `EvmChainId` from @mpilot/shared (vs bare `number`).
...
export type { TickLoopPhase as TickPhase } from '@mpilot/shared';
...
> {
  ...
  uiCardId?: UICardId;
  /** Optional MCP-spec annotations forwarded by `@mpilot/mcp`. */
