...
# Tests pass
pnpm --filter @concierge/web run test 2>&1 | grep "TrustSignals" | grep -q "PASS"
...
- **Addresses come from `@concierge/shared/addresses.ts`** — single source of truth (story-20). Don't hardcode in the component.
