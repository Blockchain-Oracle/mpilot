...
- [ ] **`npx skills add @concierge/mantle-agent`** installable + verified by demo install
- [ ] **7 npm packages published** under `@concierge/*` scope
...
- **Open-source quality** — others can `npm install @concierge/sdk` and ship their own agent within an hour of reading docs
